# Дипломный проект курса Frontend разработчик (React). Технологическая специализация [GeekBrains]

Дипломный проект представляет собой интернет-магазин обуви. Задача заключается в создании работающего приложения, всеми основными функциями которого можно пользоваться.

Большая часть разметки и стилей уже реализована и хранится в каталоге `html`. Перейдём к самому приложению.
...
Они специально закомментированы (нейтрализуя тем самым ожидание по 0-10 секунд на каждый запрос и возможные ошибки).

Запуск сервера командой `npm run watch` (после команды `npm install`) - тогда он запустится в режиме live-reload.

Для хранения состояния корзины и побочных эффектов могут использоваться на выбор:
